...
public class TemperatureExceptionDemo {
    public static void main(String[] args) {
        try {
            double temperature = 40;  // Example input
            ...
            if (temperature > 35) {
                ...
                System.out.println("Temperature is normal. Converting to Fahrenheit: " + (temperature * 9/5 + 32));
            }
